...
export const APPLICATION_API_END_POINT="http://localhost:3000/api/jobPortal/application";
export const COMPANY_API_END_POINT="http://localhost:3000/api/jobPortal/company";
